...
import { allowedKeys, generateRandomWords } from "./TimHomeHelper";
import LocalHeader from './LocalHeader'
import ErrorBeep from "../sound/beep.wav";

const initialState = {
    inputText: "Click start to begin the Five-minute Medium typing speed test",
    remainingText: "Click start to begin the Five-minute Medium typing speed test",
    completedText: "",
    showStats: false,
    progress: 0,
    accuracy: 0,
